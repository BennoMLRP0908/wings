...
// any reference to 127.0.0.1 with the IP of the sneakypanel0 network interface which will allow the
...
func (a *Allocations) DockerBindings() nat.PortMap {
	...
	// to use the sneakypanel0 network interface IP, as that is the true local for what people are
