...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"sneakypanel_nw"`
	ISPN       bool                    `default:"false" yaml:"ispn"`
	Driver     string                  `default:"bridge"`
	Mode       string                  `default:"sneakypanel_nw" yaml:"network_mode"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the sneakypanel containers are started with user namespace
	// remapping disabled
